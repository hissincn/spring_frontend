...
<template>
  <div class="min-h-full h-full">
    <nav class="flex items-center justify-between max-w-3xl p-4 mx-auto">
      <a class="inline-flex items-center justify-center w-8  rounded-lg" href="/">
    ...
    <footer class="bg-gray-100 dark:bg-gray-900">
      <div class="max-w-5xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-center">
          <img src="./src/logo.png" style="height:30px">
          <div class=" text-black font-bold text-lg dark:text-white ml-2">Spring</div>
        </div>

        <p class="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-500">
          A spring of souls ,Completing and Looking for similar souls here.
        </p>
        ...
        <nav class="mt-12" aria-labelledby="footer-navigation">
          ...
          <ul class="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
            <li>
              <a class="text-gray-700 transition hover:text-gray-700/75" href="#train">
                Train it
              </a>
            </li>
        ...
        <ul class="flex justify-center gap-6 mt-12 md:gap-8">
          ...
          <li>
            <a href="https://github.com/hissincn/spring" rel="noopener noreferrer" target="_blank"
              class="text-gray-700 transition hover:text-gray-700/75">
    ...
    <div class="bottom-12 right-4 sm:bottom-12 sm:right-4 md:bottom-12 md:right-6 lg:bottom-12 lg:right-16 float-right " style="position: fixed;">
        <a class="inline-block p-2 text-white transition bg-blue-600 rounded-full shadow sm:p-3 lg:p-4 hover:bg-blue-500"
          v-show="gotop" @click="toTop">
